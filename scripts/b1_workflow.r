# Corrida general del Workflow Semillerio // test
...
envg$EXPENV$exp_dir <- "~/buckets/b1/expwb1/"
envg$EXPENV$wf_dir <- "~/buckets/b1/flowb1/"
envg$EXPENV$repo_dir <- "~/dmeyf2024/"
envg$EXPENV$datasets_dir <- "~/buckets/b1/datasets/"
envg$EXPENV$messenger <- "~/install/zulip_enviar.sh"

envg$EXPENV$semilla_primigenia <- 261823
...
wf_SEMI_ago_b1 <- function( pnombrewf )
{
